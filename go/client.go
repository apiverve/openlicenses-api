...
const (
	baseURL        = "https://api.apiverve.com/v1/openlicenses"
	defaultTimeout = 30 * time.Second
)

// Client is the Open Source Licenses API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Open Source Licenses API client.
...
// Execute makes a request to the Open Source Licenses API with typed parameters.
//
