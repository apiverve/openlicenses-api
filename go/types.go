// Package openlicenses provides a Go client for the Open Source Licenses API.
//
// For more information, visit: https://apiverve.com/marketplace/openlicenses?utm_source=go&utm_medium=readme
package openlicenses
...
// Request contains the parameters for the Open Source Licenses API.
//
// Parameters:
//   - name (required): string - The name of the open source license to get information about
type Request struct {
...
// ResponseData contains the data returned by the Open Source Licenses API.
type ResponseData struct {
	DomainContent bool `json:"domain_content"`
	DomainData bool `json:"domain_data"`
	DomainSoftware bool `json:"domain_software"`
