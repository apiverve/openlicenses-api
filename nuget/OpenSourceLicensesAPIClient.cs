...
namespace APIVerve.API.OpenSourceLicenses
{
    ...
    /// <summary>
    /// Client for the OpenSourceLicenses API
    /// </summary>
...
#endif
    {
        ...
        public OpenSourceLicensesAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public OpenSourceLicensesAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public OpenSourceLicensesAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        private void ValidateParams(OpenSourceLicensesQueryOptions options)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(OpenSourceLicensesQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(OpenSourceLicensesQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(OpenSourceLicensesQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(OpenSourceLicensesQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(OpenSourceLicensesQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
