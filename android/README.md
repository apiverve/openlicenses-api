# Open Source Licenses Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:openlicenses-api:1.1.13'
}
```
...
```java
import com.apiverve.openlicenses.OpenSourceLicensesAPIClient;
import com.apiverve.openlicenses.APIResponse;
import com.apiverve.openlicenses.APIException;

// Initialize the client
OpenSourceLicensesAPIClient client = new OpenSourceLicensesAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("name", "MIT");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/openlicenses](https://docs.apiverve.com/ref/openlicenses)
...
- **Documentation:** [https://docs.apiverve.com/ref/openlicenses](https://docs.apiverve.com/ref/openlicenses)
- **Issues:** [GitHub Issues](https://github.com/apiverve/openlicenses-api/issues)
